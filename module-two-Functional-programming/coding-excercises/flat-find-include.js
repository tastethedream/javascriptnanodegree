...
// INCLUDE EXERCISES
// ----------------------------------------------------------
// 1. It best to use INCLUDES when what the value is does not matter, simply
// its presence. Imagine the scenario that you are need to check a user's id 
//against a list of admin id's.
...
//     '098Xc8x76m3nb4aposi'
// ]
// const idCheck = admins.includes(currentUserId);
// console.log(idCheck);
// ----------------------------------------------------------

// 2. Checking between lists. Another thing that you might need to do in real life is 
//check items between two arrays. Check if array B has any values that are also in array
// A. This becomes especially helpful when the values are hard to distinguish visually
